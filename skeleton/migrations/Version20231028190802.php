 ...
 */
final class Version20231028190802 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipes_recipes (recipes_source INT NOT NULL, recipes_target INT NOT NULL, INDEX IDX_C574D7E14484E1A9 (recipes_source), INDEX IDX_C574D7E15D61B126 (recipes_target), PRIMARY KEY(recipes_source, recipes_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE recipes_recipes ADD CONSTRAINT FK_C574D7E14484E1A9 FOREIGN KEY (recipes_source) REFERENCES recipes (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE recipes_recipes ADD CONSTRAINT FK_C574D7E15D61B126 FOREIGN KEY (recipes_target) REFERENCES recipes (id) ON UPDATE NO ACTION ON DELETE CASCADE');
