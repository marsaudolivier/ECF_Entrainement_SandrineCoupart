 ...
 */
final class Version20231101124509 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notices_recipes (notices_id INT NOT NULL, recipes_id INT NOT NULL, INDEX IDX_E8B43999A6721205 (notices_id), INDEX IDX_E8B43999FDF2B1FA (recipes_id), PRIMARY KEY(notices_id, recipes_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE notices_recipes ADD CONSTRAINT FK_E8B43999A6721205 FOREIGN KEY (notices_id) REFERENCES notices (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE notices_recipes ADD CONSTRAINT FK_E8B43999FDF2B1FA FOREIGN KEY (recipes_id) REFERENCES recipes (id) ON UPDATE NO ACTION ON DELETE CASCADE');
